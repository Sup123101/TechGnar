    ...
    public class Weapon : MonoBehaviour
    {
        ...
        public void PlaySound(AudioClips clip)
        {
            ...
            if (soundToPlay != null && audioSource != null)
            {
                ...
                if (soundToPlay == MagIn)
                {
                    if(gameObject.name == "lowpoly_glock")
                    {
                        AkSoundEngine.PostEvent("Glock_Magazine_Load", this.gameObject);
                    }
                    if (gameObject.name == "lowpoly_ak47")
                    {
                        AkSoundEngine.PostEvent("AK47_Magazine_Load", this.gameObject);
                    }
                ...
                if (soundToPlay == SlideForward)
                {
                    if (gameObject.name == "lowpoly_glock")
                    {
                        AkSoundEngine.PostEvent("Glock_Cock_Close", this.gameObject);
                    }
                    if (gameObject.name == "lowpoly_ak47")
                    {
                        AkSoundEngine.PostEvent("AK47_Cock_Close", this.gameObject);
                    }
                    if (gameObject.name == "lowpoly_shotgun")
                    {
                ...
                if (soundToPlay == SlideBack)
                {
                    ...
                    if (gameObject.name == "lowpoly_ak47")
                    {
                        AkSoundEngine.PostEvent("AK47_Cock_Open", this.gameObject);
                    }
                    if (gameObject.name == "lowpoly_shotgun")
                    {
